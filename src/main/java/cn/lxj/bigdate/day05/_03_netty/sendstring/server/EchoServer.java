package cn.lxj.bigdate.day05._03_netty.sendstring.server;
...
public class EchoServer {
    ...
    public void start() throws Exception {
        ...
        try {
            ...
            // 最后绑定服务器等待直到绑定完成，调用sync（）方法会阻塞知道服务器完成绑定，
            // 然后服务器等待通道关闭，因为使用sync()，所以关闭操作也会被阻塞。
            ChannelFuture channelFuture = serverBootstrap.bind().sync();//阻塞直到方法绑定完成
