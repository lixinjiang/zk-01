...
public class MyReflect {
    ...
    public void init() throws Exception {
        className = "cn.lxj._04_reflect.Person";
    ...
    public void otherMethod() throws Exception {
        ...
        System.out.println(Class.forName("cn.lxj._04_reflect.City").isEnum());
        //判断当前的Class对象表示是否是接口
        System.out.println("method:isInterface==================");
        System.out.println(personClass.isInterface());
        System.out.println(Class.forName("cn.lxj._04_reflect.TestInterface").isInterface());
    }
}